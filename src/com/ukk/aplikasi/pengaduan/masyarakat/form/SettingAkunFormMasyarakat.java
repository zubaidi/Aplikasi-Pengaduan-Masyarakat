 ...
 * @author zubaidi
 */
public class SettingAkunFormMasyarakat extends javax.swing.JInternalFrame {
     ...
     */
    public SettingAkunFormMasyarakat() {
        initComponents();
    ...
    private void setDataMasyarakat(){
        try {
            ResultSet rs = mk.tampilData(txtNIK.getText());
            while(rs.next()){
            ...
            Logger.getLogger(SettingAkunFormMasyarakat.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void updateDataMasyarakat(){
        ...
        try {
            mk.updateDataMasyarakat(nik, nama, username, pass, telp);
