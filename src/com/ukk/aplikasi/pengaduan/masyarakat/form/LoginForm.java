...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Login Admin dan Petugas");
    ...
    private void setLogin(){
        ...
        try {
            ResultSet rs = mk.setLoginMk(username, pass);
            if(rs.next()){
                DashboardMasyarakatForm dmf = new DashboardMasyarakatForm();
                this.dispose();
                dmf.labelNIK.setText(rs.getString("nik"));
                dmf.labelNama.setText(rs.getString("nama"));
                dmf.setVisible(true);
            }else{
